...
<option <?= $project['update_status']=="Finish"?"selected":"" ?>>Finish</option>
<option <?= $project['update_status']=="Hold"?"selected":"" ?>>Hold</option>
<option <?= $project['update_status']=="Waitlist"?"selected":"" ?>>Waitlist</option>
</select>
</div>
